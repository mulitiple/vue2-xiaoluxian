    ...
    <div class="play">
      <div class="play-left" >
        ...
        <div class="over">
          <div class="finished" >
            <p>恭喜您学完该小节</p>
            <p class="nextCourse">下一小节：123</p>
            <button class="over-btn resetLearn" >重学一遍</button>
            <button class="over-btn" >下一小节</button>
          </div>
          <div class="finished" >
            <p>恭喜您学完本课程全部内容</p>
          ...
          <el-tab-pane>
            ...
            <div class="chapter-container">
              <dl class="list" 
                ...
                :key="item.id"
              >
                <dt title="123">{{ item.chapterName }}</dt>
                <dd class="active" 
                  v-for="j in item.children"
                  :key="j.id"
                >
                  <div class="video-itemIcon" ref="">
                    <i class="el-icon-video-camera"></i>
                  </div>
                  <div class="item-name" title="44">
                    视频：{{ j.chapterName }}
                  </div>
                </dd>
              </dl>
